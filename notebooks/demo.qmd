...
# id, trange, mlats, Δt = 17, [DateTime("2021-12-01T22:19:00"), DateTime("2021-12-01T22:28")], [-63., -65.], Minute(5)
id, trange = 16, [DateTime("2022-07-02T05:00"), DateTime("2022-07-02T05:06")]
...
@chain join_df begin
    ...
    @rtransform! @astable begin # Add MLT values for each MLAT bin
        :mlt_dmsp = mlt_mean(tview(dmsp_mlt, :trange_dmsp))
