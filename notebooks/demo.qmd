...
demo_plot(f, zoom_tr, join_df, elx_flux, elx_mlt, elx_mlat, dmsp_flux, dmsp_mlt, dmsp_mlat; mlats, add_ratios=false, colormap=:cividis, mlt_offset=-3)
ax1 = f.content[1]
ylims!(ax1, 0.8, 6.8)
add_labels!(; position=Right(), padding=(0, 0, 0, 0))
# add_topbar(f[0, 1], [(-70, -68.5)])
intervals = [(-70.5, -67)]
