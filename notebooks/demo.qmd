...
begin
    ...
    elx_gei = ELFIN.gei(elx_gei_trange, probe)
    ...
    ae_max, ae = DE.maxAE(elx_gei_trange)
...
axs = quicklook(f, trange, elx_flux, elx_mlt, elx_mlat, dmsp_flux, dmsp_mlt, dmsp_mlat)
ylims!(axs[3], -84, -54)
f
easy_save("quicklook")
...
# mlats = nothing
demo_plot(Figure(; size=(800, 600)), trange, join_df, elx_flux, elx_mlt, elx_mlat, dmsp_flux, dmsp_mlt, dmsp_mlat; mlats, add_ratios=false)
