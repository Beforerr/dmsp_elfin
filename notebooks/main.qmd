...
f = Figure()
p1 = plot_x_mlat_flux(f[1, 1], tview(elx_mlat, zoom_tr), tview(elx_flux.prec, zoom_tr))
p2 = plot_x_mlat_flux(f[2, 1], tview(dmsp_mlat, trial_tr), tview(dmsp_flux, trial_tr))
xlims!(p1.axis, -54, -75)
xlims!(p2.axis, -54, -75)
...
@with successful_fits begin
    plot_parameters_variation(f_detailed, :mlat, :model, :n_points)
end
f_detailed
```
