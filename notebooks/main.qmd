...
dmsp_xs_geo = map(16:18) do id
    Speasy.get_data("ssc/dmspf$id/geo", tr...)
end
```
...
Δmlts = map(1:3) do id_idx
    elx_mlt .- dmsp_xs_mlt[id_idx]
end
Δmlats = map(1:3) do id_idx
    elx_aacgm.mlat .- dmsp_xs_aacgm[id_idx].mlat
end
```
...
```{julia}
using SPEDAS: tplot
f1(t0, t1) = tview(elx_aacgm.mlat, t0, t1)
f2s = map(Δmlts) do Δmlt
    (t0, t1) -> tview(Δmlt, t0, t1)
end
# f3s = map(Δmlats) do Δmlat
#     (t0, t1) -> tview(Δmlat, t0, t1)
# end
tplot((f1, f2s, Δmlats), "2021-01-01", "2021-01-02")
```
