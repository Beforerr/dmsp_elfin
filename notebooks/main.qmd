...
dmsp_dicts = Dict{Symbol,Any}.(:id .=> 16:18)
foreach(dmsp_dicts) do d
    d[:geo] = Speasy.get_data("ssc/dmspf$(d[:id])/geo", tr...)
end
```
...
tvars = (
    elx_flux,
    elx_aacgm.mlat,
    getindex.(dmsp_dicts, :Δmlt),
    getindex.(dmsp_dicts, :Δmlat),
)

tplot(tvars, continuous_ranges[1]...)
```
