...
valid_ranges_with_ids = find_separate_conditions(
    continuous_ranges, elx_gei; ids=dmsp_ids, Δt, Δmlt_max, Δmlat_max
)
```
...
```{julia}
result = rand(valid_ranges_with_ids_simultaneous)
